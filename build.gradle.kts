...
dependencies {
    ...
    compileOnly(
        rfg.deobf(
            "vazkii.autoreglib:AutoRegLib:1.3-32.+"
        )
    )
    ...
    compileOnly(
        rfg.deobf(
            "cofh:CoFHCore:1.12.2-4.6.3.27:universal"
        )
    )

    compileOnly(
        rfg.deobf(
            "cofh:CoFHWorld:1.12.2-1.3.1.7:universal"
        )
    )

    compileOnly(
        rfg.deobf(
            "cofh:ThermalFoundation:1.12.2-2.6.3.27:universal"
        )
    )

    compileOnly(
        rfg.deobf(
            "cofh:ThermalExpansion:1.12.2-5.5.4.43:universal"
        )
    )
